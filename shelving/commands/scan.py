...
headless guard so ``import shelving.commands.scan`` succeeds under
...
from shelving.container import read_container
from shelving.core.report import report
from shelving.core.scan import ScanError, scan
from shelving.default_catalog import DEFAULT_CATALOG
