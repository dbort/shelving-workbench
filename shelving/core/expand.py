...
:class:`~shelving.core.geometry.Space` for that item id, cross-section axes
...
from shelving.core.geometry import Space

# explicit "as" re-export: mypy --strict requires it
from shelving.core.geometry import Vec3 as Vec3
from shelving.core.layout import Axis, Board, Division, Insets, Region, Unit
from shelving.core.materials import Catalog, MaterialId
from shelving.core.solver import solve
...
def expand(unit: Unit, catalog: Catalog) -> list[BoardSpec]:
    ...
    :class:`~shelving.core.solver.LayoutSolveError`.
    """
