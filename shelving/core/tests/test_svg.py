...
from shelving.core.geometry import Vec3
...
from shelving.core.materials import Catalog, MaterialEntry, MaterialId
from shelving.core.scan import Box, export_from_json, scan
from shelving.core.solver import solve
from shelving.core.svg import rule_label, to_svg
...
def _catalog_from_thicknesses(boxes: Sequence[Box]) -> Catalog:
    ...
    :attr:`~shelving.core.scan.ScanResult.thicknesses_mm`); it must not round
