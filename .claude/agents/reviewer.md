...
- If you find a defect in already-shipped code this task's diff doesn't touch — not the new code under review, which stays in `REVIEW.md` as a normal finding — log it in `.claude/docs/bug-log.md` (rule, format, and the ad-hoc-vs-task call live there) instead of friction-log.md.
